...
public class PostRequest extends RequestProcessing {
    public PostRequest(Datasource datasource, String body) {
    ...
    public Response getApiResponse() {
        try{
            this.getBody();
            return this.request.post(this.datasource.getResourceUtl());
        }catch (Exception e){
